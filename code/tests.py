...
class UserInputTest(unittest.TestCase):
    ...
    def test_input_to_data_bits(self):
        ...
        expected:str='01001000011001010110110001101100011011110010000001110111\
0110111101110010011011000110010000100001001100010011001000110011'
...
class TestQRCode(unittest.TestCase):
    def test_concatenate_data(self):
        ...
        expected:str='01000001000101001000011001010110110001101100011011110010\
110000100000011101110110111101110010011011000110010000100001001000000011000100\
110010001100110000'
    ...
    def test_split_blocks(self):
        ...
        expected:list=[
            '0x41', '0x14', '0x86', '0x56', '0xc6', '0xc6', '0xf2', '0xc2',
    ...
    def test_error_correction(self):
        ...
        expected:list=[
            '0x85', '0xa9', '0x5e', '0x7', '0xa', '0x36', '0xc9'
            ]
    ...
    def test_add_ecc_to_concatenated_data(self):
        actual=app.QRCode(
            text_input='Hello, world! 123',
            ecc_level='low'
            )._add_ecc_to_concatenated_data()
        expected:str='01000001000101001000011001010110110001101100011011110010\
110000100000011101110110111101110010011011000110010000100001001000000011000100\
11001000110011000010000101101010010101111000000111000010100011011011001001'
    ...
    def test_calculate_penalty_first(self):
        ...
        for mask in possible_masks:
            penalty_dict[mask]=app.QRCode(
                text_input='Hello, world! 123',
                ecc_level='low',
                masking_pattern=mask
                )._calculate_penalty_first()
